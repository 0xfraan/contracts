...
contract Binary is AccessControl, Pausable {
    ...
    uint256 public maxUtilizedLiquidity;
    uint16 public minInterval;
    uint16 public maxInterval;
    uint16 public cancelBuffer;
    uint16 public leverage = 1920;
